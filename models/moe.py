...
with_sharding_constraint = partitioning.with_sharding_constraint
...
class DenseEinsumDispatcher(BaseDispatcher):
  ...
  """
    ...
    def dispatch(self, data: Array) -> Array:
        dispatch_weights = jnp.zeros(self.combine_weights, dtype=jnp.bool_)
